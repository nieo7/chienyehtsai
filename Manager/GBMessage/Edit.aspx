<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/ManagerPage.master" AutoEventWireup="true"
    CodeFile="Edit.aspx.cs" Inherits="Manager_GBMessage_Edit" ValidateRequest="false" %>
    ...
    <div class="RightTableTdContent">
        ...
        <asp:PlaceHolder ID="phcreatedate" runat="server">
            <div class="contentdiv4">
                ...
                <div class="contentdiv1right">
                    <div class="specialdivfix1">
                        <asp:TextBox ID="txtCreatedate" runat="server" CssClass="input1" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="pheditdate" runat="server">
            <div class="contentdiv4">
                ...
                <div class="contentdiv1right">
                    <div class="specialdivfix1">
                        <asp:TextBox ID="txtEditdate" runat="server" CssClass="input1" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
        </asp:PlaceHolder>
