...
public partial class Manager_BannerCategory_List : BasePage
{
    ...
    {
        GridView1.Columns[2].Visible = Tools.TryParseBoolMethod(SystemConfigBLL.getDataByClassWithName("BannerCategory", "phtitle"));
    }
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            {                
                if (bcBLL.Delete((int)GridView1.DataKeys[i].Value)>0)
                {
                    delcount++;
                }             
            }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //        BannerCategoryInfo pdClick = bcBLL.GetDataById(int.Parse(btnClick.CommandArgument.ToString()));
        //        BannerCategoryInfo pdChange = bcBLL.GetDataById(int.Parse(btnRdyChange.CommandArgument.ToString()));
        //        ClickNowSort = pdClick.gbc_sort;
        //        RdyChangeSort = pdChange.gbc_sort;
        //        pdClick.gbc_sort = RdyChangeSort;
        //        pdChange.gbc_sort = ClickNowSort;
        //        if ((i = bcBLL.Update(pdClick) + bcBLL.Update(pdChange)) > 1)
        //        {
        //            ShowMessage("排序成功");
    ...
    {
        if (bcBLL.Delete(int.Parse(e.CommandArgument.ToString())) > 0)
        {
            ShowMessage("刪除成功");
        }
        GridView1.DataBind();        
