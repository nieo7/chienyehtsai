<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/ManagerPage.master" AutoEventWireup="true"
    CodeFile="List.aspx.cs" Inherits="Manager_ProductCategory_List" Debug="true" %>
        ...
        <ContentTemplate>
            ...
            <div class="RightTableTdTopmenublue">
                <ul>
                    ...
                    <li id="toplink3" title="產品列表"><a href="../Products/List.aspx">產品列表</a></li>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                SelectMethod="GetDataByLid" TypeName="ProductsTableAdapters.ProductCategoryTableAdapter"
                DeleteMethod="Delete" InsertMethod="Insert" UpdateMethod="Update">
                <DeleteParameters>
                    <asp:Parameter Name="Original_pc_id" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="pc_name" Type="String" />
                    <asp:Parameter Name="pc_fatherid" Type="Int32" />
                    <asp:Parameter Name="pc_sorting" Type="Int32" />
                    <asp:Parameter Name="pc_image" Type="String" />
                    <asp:Parameter Name="pc_thumb" Type="String" />
                    <asp:Parameter Name="pc_show" Type="Boolean" />
                            ...
                            <div class="inner">
                                <div class="content">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                        CssClass="grid" EmptyDataText="此次查詢資料庫沒有資料!" DataKeyNames="pc_id" OnRowDataBound="GridView1_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="pc_id" HeaderText="編號" Visible="false" SortExpression="pc_id" />
                                            <asp:BoundField DataField="pc_sorting" HeaderText="排序" ItemStyle-Width="320px" SortExpression="pc_sorting">
                                                <ItemStyle Width="50px" />
                                            </asp:BoundField>
                                            <asp:TemplateField HeaderText="首圖">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hyImg" runat="server">
                                                        <asp:Image ID="Image1" runat="server" Width="50px" ImageUrl='<%#Tools.GetAppSettings("ProductImageTruePath")+Eval("pc_image").ToString() %>' /></asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="pc_name" HeaderText="標題" ItemStyle-Width="320px" SortExpression="pc_name">
                                                <ItemStyle Width="320px" />
                                            </asp:BoundField>
                                            <asp:TemplateField HeaderText="產品主類別">
                                                <ItemTemplate>
                                                    <%#getTitle(int.Parse(Eval("pc_fatherid").ToString())) %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:CheckBoxField DataField="pc_show" HeaderText="是否顯示">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:CheckBoxField>
                                            <asp:HyperLinkField DataNavigateUrlFields="pc_id" DataNavigateUrlFormatString="Edit.aspx?id={0}"
                                                HeaderText="編輯" Text="編輯"></asp:HyperLinkField>
                                            <asp:TemplateField HeaderText="刪除" ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:Button ID="Button2" runat="server" OnCommand="Button2_Command" CommandArgument='<%#Eval("pc_id") %>'
