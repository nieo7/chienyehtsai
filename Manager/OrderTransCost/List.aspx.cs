...
public partial class Manager_OrderTransCost_List : BasePage
{
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            {
                delcount++;
                otcBLL.Delete((int)GridView1.DataKeys[i].Value);
            }
        }
        if (delcount != 0)
        {
    ...
    {
        otcBLL.Delete(int.Parse(e.CommandArgument.ToString()));
        GridView1.DataBind();
        ShowMessage("刪除成功");
    }
