<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Manager/ManagerPage.master"
    AutoEventWireup="true" CodeFile="AdminItemEditList.aspx.cs" Inherits="Manager_Admin_EditList"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="RightTableTdTopmenublue">
        <ul>
            ...
            <li id="toplink2" title="返回"><a href='<%="AdminItemList.aspx?id="+id %>'>返回</a></li>
        ...
        <ContentTemplate>
            <div class="RightTableTdContent">
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetAllItem2WithItem1" TypeName="AdminTableAdapters.AdminItem2TableAdapter"
                            ...
                            <div class="inner">
                                <div class="content">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                        CssClass="grid" OnPageIndexChanged="GridView1_PageIndexChanged" OnRowDataBound="GridView1_RowDataBound"
                                        DataSourceID="ObjectDataSource1" AllowSorting="True" PageSize="100" ShowFooter="True"
                                        EnableModelValidation="True">
                                        <Columns>
                                            <asp:BoundField DataField="ai2_id" HeaderText="ai2_id" Visible="false" SortExpression="ai2_id">
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="權限設定">
                                                <FooterTemplate>
                                                    ...
                                                    <asp:Button ID="btSave" runat="server" Text="    確認    " OnClick="btSave_Click" />
                                                </FooterTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lbfi_no1" runat="server" Text='<%# Eval("ai2_no1") %>' Visible="False"></asp:Label>
                                                    <asp:Label ID="lbfi_no2" runat="server" Text='<%# Eval("ai2_id") %>' Visible="False"></asp:Label>
