<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/ManagerPage.master" AutoEventWireup="true"
    CodeFile="List.aspx.cs" Inherits="Manager_GBCategory_List" %>
        ...
        <ContentTemplate>
            ...
            <div class="RightTableTdContent">
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                    ...
                    TypeName="GBMessageTableAdapters.GBCategoryTableAdapter" DeleteMethod="Delete" 
                    InsertMethod="Insert" UpdateMethod="Update">
                    <DeleteParameters>
                        <asp:Parameter Name="Original_gbc_id" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="gbc_title" Type="String" />
                        <asp:Parameter Name="gbc_sort" Type="Int32" />
                        <asp:Parameter Name="gbc_show" Type="Boolean" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="gbc_title" Type="String" />
                        <asp:Parameter Name="gbc_sort" Type="Int32" />
                                ...
                                <div class="content">
                                    ...
                                    <div style="text-align: center;">
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            CssClass="grid" DataKeyNames="gbc_id" DataSourceID="ObjectDataSource1" EmptyDataText="此次查詢資料庫沒有資料"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="gbc_id" HeaderText="文章編號" SortExpression="gbc_id" Visible="false" />
                                                <asp:BoundField DataField="gbc_title" HeaderText="標題" SortExpression="gbc_title"/>                                                                                              
                                                <asp:TemplateField HeaderText="編輯" ItemStyle-Width="30px">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="hyEdit" runat="server" NavigateUrl='<%# string.Format("Edit.aspx?id={0}",Eval("gbc_id")) %>'
                                                            Text="編輯"></asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="刪除" ShowHeader="False" ItemStyle-Width="30px">
                                                    <ItemTemplate>
                                                        <asp:Button ID="Button2" runat="server" CommandArgument='<%#Eval("gbc_id") %>' CommandName="myDelete"
