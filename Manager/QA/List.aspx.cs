...
public partial class Manager_QA_List : BasePage
{
    ...
    {
        ObjectDataSource1.FilterExpression = AddMethodSystem.DecodeHtml2(AddMethodSystem.SearchWHEREStringObject("q_title", txtKeyWord.Text,""));
    }
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            {
                delcount++;
                qBLL.Delete((int)GridView1.DataKeys[i].Value);
            }
        }
        if (delcount != 0)
        {
    ...
    protected void Button2_Command(object sender, CommandEventArgs e)
    {
        ...
        if (qBLL.Delete(int.Parse(e.CommandArgument.ToString())) > 0)
        {
            ShowMessage("刪除成功");
        }
        GridView1.DataBind();        
